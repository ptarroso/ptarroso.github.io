...
```{r 20200930_triplot_example, echo=FALSE, warning=FALSE, message=FALSE}
include_graphics("assets/images/20200930_triplot_example.svg")
```
...
```{r openLibraries, warning=FALSE, message=FALSE}
library(raster)
library(assortedViz)
```
...
```{r 20200930_triplot1, results=FALSE}
...
```{r 20200930_triplot2, results=FALSE}
triplot(df$bio1, df$bio12, df$y, df$spRich, size=0.04,
...
```{r 20200930_triplot3, results=FALSE}
...
```{r 20200930_histprec, fig.height=4}
layout(matrix(1:2, 1))
hist(df$bio12)
hist(log1p(df$bio12))
```
...
```{r 20200930_triplot4, results=FALSE}
...
```{r 20200930_histrich, fig.height=4}
layout(matrix(1:2, 1))
hist(df$spRich)
...
```{r 20200930_triplot5, results=FALSE}
...
```{r 20200930_triplot6, results=FALSE}
...
```{r 20200930_triplot7, results=FALSE}
...
```{r 20200930_triplot8, results=FALSE}
x1 <- seq(-50, 30, 10)
...
```{r 20200930_triplot9, results=FALSE}
...
```{r 20200930_triplot_og, echo=FALSE, results=FALSE, fig.show='hide'}
# Image to associate with the post
triplot(df$bio1, log1p(df$bio12), df$elev, df$spRich,
  size=0.04, FUN=mean, col.FUN=rich.colors, displayNA=F,
  border="white", scale=FALSE, x1.at=NA, x2.at=NA, y.at=NA)
```
